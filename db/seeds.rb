...
review_data = [
  { user_id: 1, part_id: 1, rating: 4, comment: "Great product!" },
  { user_id: 2, part_id: 2, rating: 5, comment: "Works perfectly!" },
  { user_id: 3, part_id: 3, rating: 3, comment: "Decent quality." },
...
Review.create([
  {
    ...
    part: Part.find(1),
    rating: 5,
    comment: 'Excellent part, highly recommended!',
  },
  {
    user: User.find(2),
    part: Part.find(2),
  ...
  },
  {
    ...
    part: Part.find(1),
    rating: 5,
    comment: 'Perfect fit for my vehicle!',
  },
  {
    user: User.find(4),
    part: Part.find(3),
  ...
  },
  {
    ...
    part: Part.find(2),
    rating: 5,
    comment: 'Highly durable and reliable part.',
  },
  {
    user: User.find(4),
    part: Part.find(1),
  ...
  },
  {
    ...
    part: Part.find(6),
    rating: 4,
    comment: 'Great value for the money.',
  },
  {
    user: User.find(2),
    part: Part.find(7),
    rating: 5,
    comment: 'Outstanding performance and quality!',
  },
])

puts 'Sample reviews have been seeded.'
